...
<body class="hold-transition skin-blue sidebar-mini" id="loading">
    <div class="wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?php echo site_url('boss/views/' . $platform . '/' . $appid . '/pay1'); ?>"><i class="fa fa-circle-o"></i> 付费金额</a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    付费金额&nbsp;-&nbsp;<?php echo $platform; ?>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">BOSS</li>
                    <li class="active">付费金额</li>
                </ol>
            </section>
    ...
    <script type="text/javascript">
        ...
        function fillTableData(start, end) {
            showLoading();
            $.post('<?php echo site_url("boss/pay"); ?>',
                {
