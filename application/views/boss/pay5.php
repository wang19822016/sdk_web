                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('boss/views/' . $platform . '/' . $appid . '/pay5'); ?>"><i class="fa fa-circle-o"></i> 鲸鱼用户</a></li>
                        </ul>
                    </li>
                    <li class="">
            ...
            $.ajax({
                ...
                success:function(result) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        line += '<td>';
                        line += Math.round(result[i].money);
						line += '</td>';

						line += '<td>';
                        line += Math.round(result[i].weekmoney);
						line += '</td>';

						line += '<td>';
                        line += Math.round(result[i].monthmoney);
						line += '</td>';
