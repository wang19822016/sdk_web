                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="active"><a href="<?php echo site_url('boss/views/' . $appid . '/pay3'); ?>"><i class="fa fa-circle-o"></i> 付费率</a></li>
            ...
            $.ajax({
                ...
                success:function(result) {
                    ...
                    for (var key in result) {
                        ...
                        for (var i = 1; i < 31; i++) {
                            line += '<td>';
                            if (result[key][String(i)].payRate.length == 0)
                                line += '';
                            else
