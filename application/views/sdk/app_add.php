                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li class=""><a href="<?php echo site_url('sdk'); ?>"><i class="fa fa-circle-o"></i> 列表</a></li>
                            <li class="active"><a href="<?php echo site_url('sdk/app/0'); ?>"><i class="fa fa-circle-o"></i> 添加</a></li>
                        </ul>
                    </li>
                    <li class="">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <!-- /.box-header -->
                            <form role="form" action="<?php echo site_url('sdk/app/0'); ?>" method="post">
                                <div class="box-body">
