                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <form role="form" action="<?php echo site_url('sdk/sku/' . $id . '/' . $sku->sku); ?>" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="name">名称</label>
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $sku->name; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="price">价格</label>
                                        <input type="text" class="form-control" id="price" name="price" value="<?php echo $sku->price ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="currency">货币单位</label>
                                        <input type="text" class="form-control" id="currency" name="currency" value="<?php echo $sku->currency ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>平台</label>
                                        <select class="form-control" name="platform">
                                            <option value="1" <?php if ($sku->platform == 0) echo 'selected'; ?>>Google</option>
                                            <option value="2" <?php if ($sku->platform == 0) echo 'selected'; ?>>Apple</option>
                                            <option value="3" <?php if ($sku->platform == 0) echo 'selected'; ?>>MyCard</option>
                                            <option value="4" <?php if ($sku->platform == 0) echo 'selected'; ?>>PayPal</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- /.box-body -->
